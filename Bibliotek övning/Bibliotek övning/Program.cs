...
namespace Bibliotek_övning
{
    class Program
    {
                ...
                else if (choice == "2")
                {
                    ...
                    for (int i = 0; i < usernamefile.Length; i++)
                    {
                        if (loginun == usernamefile[i] && loginpw == passwordfile[i])
                        {
                            ...
                            if (access == "Medlem")
                                Member(bookfile, passwordfile, position);
            ...
            while (login == true && position <= 1)
            {
                ...
                if (choice2 == "2")
                {
                    ...
                    if (change == "1")
                    {
                        ...
                        bookfile.Add($"{replacename} {replaceauthor} {bookyear} {bookamount} {bookisbn}");
        ...
        static void Member(List<string> bookfile, string[] passwordfile, int position)
        {
